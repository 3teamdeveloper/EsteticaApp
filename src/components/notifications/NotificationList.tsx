  ...
  return (
    <div className="w-full md:w-2/3 bg-white text-gray-900 shadow-sm p-3 sm:p-4 overflow-y-auto border-r border-gray-200">
      <div className="flex items-center pt-8 justify-between mb-2 sm:mb-3">
        <h2 className="text-2xl sm:text-lg font-semibold">{t('title')}</h2>
        <div className="flex items-center gap-1.5">
          <button
            ...
            title={t('filters.today_title')}
            aria-label={t('filters.today_title')}
          >
            <CalendarClock className="w-3.5 h-3.5" />
            <span className="hidden sm:inline">{t('filters.today')}</span>
          </button>
          <button
            ...
            title={t('filters.seven_days_title')}
            aria-label={t('filters.seven_days_title')}
          >
            <Calendar className="w-3.5 h-3.5" />
            <span className="hidden sm:inline">{t('filters.seven_days')}</span>
          </button>
          <button
            ...
            title={t('filters.all_title')}
            aria-label={t('filters.all_title')}
          >
