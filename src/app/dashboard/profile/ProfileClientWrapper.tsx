  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pt-8">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Editar Perfil Público</h1>
        {profileData?.urlName && (
          <Link
            href={`/${profileData.urlName}`}
            target="_blank"
            className="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 border border-gray-300 dark:border-gray-600 min-w-[140px] rounded-md px-2 py-1 flex items-center gap-2"
          >
